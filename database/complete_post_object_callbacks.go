...
// last step of the PreparePostObject -> upload-to-S3 -> CompletePostObject
// flow the game uses to publish a Network Link / My Fairy object. Without
// them the common protocol aborts that call with
// "GetObjectOwnerByDataID not defined".
